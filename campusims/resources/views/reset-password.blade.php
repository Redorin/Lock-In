...
<head>
    ...
    <style>
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
        ...
        .card{background:#fff;border:1px solid rgba(0,0,0,.08);border-radius:20px;padding:36px 32px;box-shadow:0 4px 24px rgba(0,0,0,.06),inset 0 1px 0 rgba(255,255,255,.8);animation:cardIn .5s cubic-bezier(.22,1,.36,1) both;}
        ...
        .sbtn{width:100%;padding:13px;background:linear-gradient(135deg,#1e3a8a,#2563eb,#3b82f6);color:#fff;font-family:'Plus Jakarta Sans',sans-serif;font-weight:700;font-size:.95rem;border:none;border-radius:11px;cursor:pointer;box-shadow:0 4px 20px rgba(37,99,235,.3);transition:all .2s;margin-top:4px;position:relative;overflow:hidden;}
