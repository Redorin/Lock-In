...
<style>
    ...
    @media(max-width:600px){
        .stats{grid-template-columns: 1fr; gap:12px;}.stat{padding:18px;}
        .sc { flex-direction: column; align-items: flex-start; gap: 14px; }
        .sc-right { width: 100%; justify-content: space-between; }
        .pt { width: 100px; }
